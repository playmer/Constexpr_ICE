...
namespace YTE
{
  ...
  protected:
    template <typename tKeyPossibleType, typename tStoredType>
    static inline bool comparatorLowerBound(const std::pair<KeyType, tStoredType> &lhs, const tKeyPossibleType &rhs)
    {
    ...
    template <typename tKeyPossibleType, typename tStoredType>
    static inline bool comparatorUpperBound(const tKeyPossibleType &lhs, const std::pair<KeyType, tStoredType> &rhs)
    {
